...
function makeGlowingParticles() {
  let particleTexture = new THREE.TextureLoader().load(
    "../src/assets/img/texture_particules/particule_10_2.png"
  );
...
function makeSpriteArbre() {
  let spriteMap = new THREE.TextureLoader().load(
    "../src/assets/img/boutons/passif/bouton_1_passif.png"
  );
  let spriteMap2 = new THREE.TextureLoader().load(
    "../src/assets/img/boutons/passif/bouton_2_passif.png"
  );
  let spriteMap3 = new THREE.TextureLoader().load(
    "../src/assets/img/boutons/passif/bouton_3_passif.png"
  );
  let spriteMap4 = new THREE.TextureLoader().load(
    "../src/assets/img/boutons/passif/bouton_4_passif.png"
  );
...
function makeData() {
  ...
  loader.load(
    "../src/assets/data/json/dataFire.js",
...
/* CreateGeom */
function makeArbre() {
  let textureArbre = new THREE.TextureLoader().load(
    "../src/assets/models/baking/baking_jpg/baking_2048.jpg"
  );
  ...
  jsonLoader.load("../src/assets/models/arbre_3D/arbre_carte_4.js", function (
    geometry,
    materials
  ) {
  ...
  for (var i = 0; i < intersectsSprites.length; i++) {
    ...
    switch (INTERSECTED.name) {
      case "spriteArbre1":
        ...
        INTERSECTED.material.map.image.src =
          "../src/assets/img/boutons/actif/bouton_1_actif.png";
        ...
        timeLine
          .to("#humainsScore", 0.2, { opacity: 0, x: 0 })
          .to("#contenuScore", 0.3, { opacity: 0, x: 0 }, 0) //reset
          .to(datasSprites, 2.5, {
            humains: "90",
            roundProps: "humains",
            onUpdate: () => {
              humainsScore.innerHTML = datasSprites.humains + "%";
              contenuScore.innerHTML =
                "des feux de forêts sont causés <strong>par l'homme</strong>";
            },
            ease: Circ.easeInOut,
          })
          .to(
      ...
      case "spriteArbre2":
        ...
        INTERSECTED.material.map.image.src =
          "../src/assets/img/boutons/actif/bouton_2_actif.png";
        ...
        timeLine
          ...
          .to(datasSprites, 2.5, {
            ...
            onUpdate: () => {
              ...
              contenuScore.innerHTML =
                "feux de forêts signalés en <strong> une journée seulement</strong>, <br>le <strong>22 novembre</strong> 2017";
            },
            ease: Circ.easeInOut,
          })
          .to(
      ...
      case "spriteArbre3":
        ...
        INTERSECTED.material.map.image.src =
          "../src/assets/img/boutons/actif/bouton_3_actif.png";
        ...
        timeLine
          ...
          .to(datasSprites, 5.5, {
            ...
            onUpdate: () => {
              ...
              contenuScore.innerHTML =
                "d'hectares brulés, c'est le <strong>plus grand feu de l'histoire</strong> en Russie, 2003 ";
            },
            ease: Circ.easeInOut,
          })
          .to(
      ...
      case "spriteArbre4":
        ...
        INTERSECTED.material.map.image.src =
          "../src/assets/img/boutons/actif/bouton_4_actif.png";
        ...
        timeLine
          ...
          .to(datasSprites, 5.5, {
            ...
            onUpdate: () => {
              ...
              contenuScore.innerHTML =
                "la destruction des forêts, c'est <br><strong> 20% des émissions globales des gaz à effets de serre</strong><br>en plus dans le monde ";
            },
            ease: Circ.easeInOut,
          })
          .to(
...
function render() {
  ...
  for (let i = 0; i < particleGroup.children.length; i++) {
    ...
    let pulseFactor =
      Math.sin(particleAttributes.randomness[i] * time) * 0.025 + 3.5;
